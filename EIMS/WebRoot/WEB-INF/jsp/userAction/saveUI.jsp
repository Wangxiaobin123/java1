...
<head>
    ...
    <script>
		...
		var psw2 = document.lform.repassword.value;
		if(psw2 != psw1){
		alert("两次密码输入不一致,请重新修改！");
		document.lform("lform").password.focus();//光标定位在文本框acccountName中
		return false;
		}
		return true;
		}
...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="user_%{ id == null ? 'add' : 'edit'}" onSubmit="return(validate())" id="lform" name="lform">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">所属部门</td>
                        <td>
                        	<s:select name="departmentId" listKey="id" listValue="name"
                        	list="#departmentList" headerKey="" headerValue="==请选择部门=="
                    ...
                    <tr><td>姓名</td>
                        <td><s:textfield type="password" name="name" cssclass="InputStyle"/></td>
                    </tr>
                    <tr><td>新 密码：</td>
                        <td> 
                    ...
                    <tr><td>确认密码：</td>
                        ...
                        <s:password name="repassword" cssclass="InputStyle"><s:fielderror/></s:password>
